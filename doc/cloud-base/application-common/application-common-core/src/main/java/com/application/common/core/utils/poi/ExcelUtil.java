package com.application.common.core.utils.poi;

import com.application.common.core.annotation.Excel;
import com.application.common.core.annotation.Excel.ColumnType;
import com.application.common.core.annotation.Excel.Type;
import com.application.common.core.annotation.Excels;
import com.application.common.core.exception.UtilException;
import com.application.common.core.text.Convert;
import com.application.common.core.utils.DateUtils;
import com.application.common.core.utils.StringUtils;
import com.application.common.core.utils.file.FileTypeUtils;
import com.application.common.core.utils.file.ImageUtils;
import com.application.common.core.utils.reflect.ReflectUtils;
            ...
            for (Excel attr : excels) {
                if (StringUtils.isNotEmpty(includeFields)) {
                    if (ArrayUtils.contains(
                                    this.includeFields, field.getName() + "." + attr.targetAttr())
                    ...
                    if (!ArrayUtils.contains(
                                    this.excludeFields, field.getName() + "." + attr.targetAttr())
                            && (attr != null && (attr.type() == Type.ALL || attr.type() == type))) {
                        field.setAccessible(true);
                        fields.add(new Object[] {field, attr});
                    }
        ...
        if (StringUtils.isNotEmpty(attr.prompt()) || attr.combo().length > 0) {
            if (attr.combo().length > 15 || StringUtils.join(attr.combo()).length() > 255) {
                ...
                setXSSFValidationWithHidden(
                        sheet, attr.combo(), attr.prompt(), 1, 100, column, column);
            } else {
                // 提示信息或只能选择不能输入的列内容.
