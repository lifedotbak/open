...
public class TopicType extends ExtensibleDocumented {
     ...
     *
     * @param value allowed object is {@link QueryExpressionType }
     */
     ...
     * why there is not a <CODE>set</CODE> method for the topic property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link TopicType }
     */
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the messageTypes property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
