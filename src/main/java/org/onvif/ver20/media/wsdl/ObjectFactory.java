...
public class ObjectFactory {
    ...
    public JAXBElement<Capabilities2> createCapabilities(Capabilities2 value) {
        return new JAXBElement<Capabilities2>(
                _Capabilities_QNAME, Capabilities2.class, null, value);
    }
    ...
    public JAXBElement<GetConfiguration> createGetVideoSourceConfigurations(
            GetConfiguration value) {
        return new JAXBElement<GetConfiguration>(
    ...
    public JAXBElement<GetConfiguration> createGetVideoEncoderConfigurations(
            GetConfiguration value) {
        return new JAXBElement<GetConfiguration>(
    ...
    public JAXBElement<GetConfiguration> createGetAudioOutputConfigurations(
            GetConfiguration value) {
        return new JAXBElement<GetConfiguration>(
    ...
    public JAXBElement<GetConfiguration> createGetAudioSourceConfigurations(
            GetConfiguration value) {
        return new JAXBElement<GetConfiguration>(
    ...
    public JAXBElement<GetConfiguration> createGetAudioDecoderConfigurations(
            GetConfiguration value) {
        return new JAXBElement<GetConfiguration>(
    ...
    public JAXBElement<GetConfiguration> createGetAudioEncoderConfigurations(
            GetConfiguration value) {
        return new JAXBElement<GetConfiguration>(
