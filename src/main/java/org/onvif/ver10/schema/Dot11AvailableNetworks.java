...
public class Dot11AvailableNetworks {
     ...
     * why there is not a <CODE>set</CODE> method for the authAndMangementSuite property.
     *
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the pairCipher property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the groupCipher property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
