...
/**
 * Describe the option of the color supported. Either list each color or define the range of color
 * value. The following values are acceptable for Colourspace attribute.
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>Java-Klasse f�r ColorOptions complex type.
 *
...
public class ColorOptions {
     ...
     * why there is not a <CODE>set</CODE> method for the colorList property.
     *
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the colorspaceRange property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
