 ...
 * by the NVT and can be either static or created dynamically by the NVT. For example, the dynamic
 * configurations can be created by the NVT depending on current available encoding resources.
 *
