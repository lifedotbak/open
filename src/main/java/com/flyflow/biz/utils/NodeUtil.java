...
public class NodeUtil {
    ...
    public static void handleNodeAddExecutionId(Node node, String nodeId, String executionId) {
        ...
        if (!com.flyflow.common.utils.NodeUtil.isNode(node)) {
            return;
        }
    ...
    public static void handEmptyNode(Node node) {
        ...
        if (!com.flyflow.common.utils.NodeUtil.isNode(node.getChildNode())) {
    ...
    public static String getLastNodeId(String flowId, String nodeId, String parentNodeId) {
        ...
        Node parentNode = com.flyflow.common.utils.NodeUtil.getParentNode(node, nodeId, false);
        if (parentNode == null) {
            return null;
        }
