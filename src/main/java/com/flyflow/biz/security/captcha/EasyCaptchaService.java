package com.flyflow.biz.security.captcha;

import com.flyflow.biz.constants.SecurityConstants;
import cn.hutool.core.util.IdUtil;
import com.flyflow.biz.config.CaptchaConfig;
...
public class EasyCaptchaService {
    ...
    public R<CaptchaResult> getCaptcha() {
        ...
        redisTemplate
                .opsForValue()
                .set(
                        SecurityConstants.VERIFY_CODE_CACHE_PREFIX + verifyCodeKey,
                        captchaText,
                        captchaConfig.getTtl(),
                        TimeUnit.SECONDS);
