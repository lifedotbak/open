...
import com.flyflow.biz.utils.WxCpHttpUtil;
...
public class WxCpApi implements ApiStrategy, InitializingBean {
    ...
    public List<String> queryUserIdListByRoleIdListAndDeptIdList(UserQueryDto userQueryDto) {
        String post =
                WxCpHttpUtil.post(userQueryDto, "/user/loadUserIdListByRoleIdListAndDeptIdList");
    ...
    public List<DeptDto> loadAllDept(String parentDeptId) {
        String post =
                WxCpHttpUtil.get("/dept/all?deptId=" + (parentDeptId == null ? "" : parentDeptId));
