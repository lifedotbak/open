...
import com.flyflow.biz.utils.FsHttpUtil;
...
public class FsApi implements ApiStrategy, InitializingBean {
    ...
    public List<String> queryUserIdListByRoleIdListAndDeptIdList(UserQueryDto userQueryDto) {
        String post =
                FsHttpUtil.post(userQueryDto, "/user/loadUserIdListByRoleIdListAndDeptIdList");
    ...
    public List<DeptDto> loadAllDept(String parentDeptId) {
        String post =
                FsHttpUtil.get("/dept/all?deptId=" + (parentDeptId == null ? "" : parentDeptId));
