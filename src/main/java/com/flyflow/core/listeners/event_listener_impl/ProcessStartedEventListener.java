...
import static com.flyflow.common.constants.ProcessInstanceConstant.VariableKey.*;
...
import com.flyflow.common.dto.ProcessInstanceRecordParamDto;
    ...
    public void handle(FlowableEvent event) {
        ...
        String nestedProcessInstanceId = flowableProcessStartedEvent.getNestedProcessInstanceId();
        {
            ...
            redisTemplate
                    ...
                    .add(
                            StrUtil.format(
                                    REDIS_KEY_OF_FLOW_UNIQUE_ID, entity.getProcessInstanceId()),
                            StrUtil.format("{}||||{}", START_NODE, s),
        ...
        String tenantId = entity.getTenantId();
        {
            ...
            runtimeService.setVariable(
                    processInstanceId, PROCESS_INSTANCE_CODE, processInstanceBizCode);
            ...
            processInstanceRecordParamDto.setMainDeptId(
                    MapUtil.getStr(variables, START_USER_MAIN_DEPTID_KEY));
