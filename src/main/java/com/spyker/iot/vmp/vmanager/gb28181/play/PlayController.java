package com.spyker.iot.vmp.vmanager.gb28181.play;
...
public class PlayController {
    ...
    public void playConvertStop(@PathVariable String key, String mediaServerId) {
        if (mediaServerId == null) {
            throw new ControllerException(
                    ErrorCode.ERROR400.getCode(), "流媒体：" + mediaServerId + "不存在");
        }
    ...
    public AudioBroadcastResult broadcastApi(
            @PathVariable String deviceId,
            @PathVariable String channelId,
            Integer timeout,
    ...
    public void stopBroadcast(@PathVariable String deviceId, @PathVariable String channelId) {
        ...
        //			throw new ControllerException(ErrorCode.ERROR100.getCode(), "命令发送失败: " +
        // e.getMessage());
        //		}
        playService.stopAudioBroadcast(deviceId, channelId);
    }
