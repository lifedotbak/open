...
public class CommonGbChannel {
    ...
    /** 国标字段：摄像机类型: 1-球机; 2-半球; 3-固定枪机; 4-遥控枪机 */
    @Schema(description = "摄像机类型")
    private Integer ptzType;

    /**
     * 国标字段：摄像机位置类型扩展。 1-省际检查站、 2-党政机关、 3-车站码头、 4-中心广场、 5-体育场馆、 6-商业中心、 7-宗教场所、 8-校园周边、 9-治安复杂区域、
     * 10-交通干线
     */
    @Schema(description = "摄像机位置类型扩展")
    private Integer positionType;

    /** 国标字段：安装位置室外、室内属性 1-室外、 2-室内 */
    @Schema(description = "安装位置室外、室内属性")
    private Integer roomType;

    /** 国标字段：用途 1-治安、 2-交通、 3-重点、 */
    @Schema(description = "用途")
    private Integer useType;

    /** 国标字段：补光属性 1-无补光、 2-红外补光、 3-白光补光 */
