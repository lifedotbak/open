package com.spyker.iot.vmp.gb28181.transmit.event.timeout.impl;
...
public class TimeoutProcessorImpl implements InitializingBean, ITimeoutProcessor {
    ...
    @Autowired private SIPProcessorObserver processorObserver;
    ...
    public void process(TimeoutEvent event) {
        try {
            ...
            SipSubscribe.EventResult<TimeoutEvent> timeoutEventEventResult =
                    new SipSubscribe.EventResult<>(event);
