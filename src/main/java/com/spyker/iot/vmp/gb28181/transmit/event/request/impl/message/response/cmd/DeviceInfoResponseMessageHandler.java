 ...
 */
@Component
public class DeviceInfoResponseMessageHandler extends SIPRequestProcessorParent
        implements InitializingBean, IMessageHandler {

    private final String cmdType = "DeviceInfo";
    private final Logger logger = LoggerFactory.getLogger(DeviceInfoResponseMessageHandler.class);
    ...
    public void handForDevice(RequestEvent evt, Device device, Element rootElement) {
        ...
        if (device == null || !device.isOnLine()) {
            logger.warn(
                    "[接收到DeviceInfo应答消息,但是设备已经离线]：" + (device != null ? device.getDeviceId() : ""));
            return;
        }
        ...
        try {
            ...
            String key =
                    DeferredResultHolder.CALLBACK_CMD_DEVICEINFO + device.getDeviceId() + channelId;
