package com.spyker.iot.vmp.gb28181.session;
...
public class VideoStreamSessionManager {
    ...
    public void put(
        ...
        redisTemplate
                .opsForValue()
                .set(
                        VideoManagerConstants.MEDIA_TRANSACTION_USED_PREFIX
    ...
    public SsrcTransaction getSsrcTransaction(
            String deviceId, String channelId, String callId, String stream) {
        ...
        if (!scanResult.isEmpty()) {
            ...
            for (Object keyObj : scanResult) {
                SsrcTransaction ssrcTransaction =
                        (SsrcTransaction) redisTemplate.opsForValue().get(keyObj);
    ...
    public List<SsrcTransaction> getSsrcTransactionForAll(
            String deviceId, String channelId, String callId, String stream) {
        if (ObjectUtils.isEmpty(deviceId)) {
            deviceId = "*";
        }
    ...
    public void remove(String deviceId, String channelId, String stream) {
        List<SsrcTransaction> ssrcTransactionList =
                getSsrcTransactionForAll(deviceId, channelId, null, stream);
    ...
    public List<SsrcTransaction> getAllSsrc() {
        List<Object> ssrcTransactionKeys =
                RedisUtil.scan(
                        redisTemplate,
                        String.format(
                                "%s_*_*_*_*",
        ...
        for (Object ssrcTransactionKey : ssrcTransactionKeys) {
            ...
            SsrcTransaction ssrcTransaction =
                    JsonUtil.redisJsonToObject(redisTemplate, key, SsrcTransaction.class);
