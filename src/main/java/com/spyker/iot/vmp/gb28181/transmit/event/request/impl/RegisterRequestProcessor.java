...
import com.spyker.iot.vmp.gb28181.auth.DigestServerAuthenticationHelper;
import com.spyker.iot.vmp.gb28181.bean.Device;
import com.spyker.iot.vmp.gb28181.bean.GbSipDate;
    ...
    public void process(RequestEvent evt) {
        try {
            ...
            if (device != null
                    ...
                    && request.getCallIdHeader()
                            .getCallId()
                            .equals(device.getSipTransactionInfo().getCallId())) {
                ...
                if (registerFlag) {
                    ...
                    sipSender.transmitRequest(
                            request.getLocalAddress().getHostAddress(), registerOkResponse);
                    device.setRegisterTime(DateUtil.getNow());
                    SipTransactionInfo sipTransactionInfo =
                            new SipTransactionInfo((SIPResponse) registerOkResponse);
            ...
            String password =
                    (device != null && !ObjectUtils.isEmpty(device.getPassword()))
                            ? device.getPassword()
                            : sipConfig.getPassword();
            AuthorizationHeader authHead =
            ...
            // 使用自己修改的
            GbSipDate gbSipDate =
                    new GbSipDate(Calendar.getInstance(Locale.ENGLISH).getTimeInMillis());
            ...
            if (registerFlag) {
                ...
                device.setRegisterTime(DateUtil.getNow());
                SipTransactionInfo sipTransactionInfo =
                        new SipTransactionInfo((SIPResponse) response);
                deviceService.online(device, sipTransactionInfo);
            } else {
