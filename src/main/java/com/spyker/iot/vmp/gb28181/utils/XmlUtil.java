...
public class XmlUtil {
    ...
    public static DeviceChannel channelContentHandler(
            Element itemDevice, Device device, String event) {
        ...
        if (event != null
                && !event.equals(CatalogEvent.ADD)
                && !event.equals(CatalogEvent.UPDATE)) {
     ...
     */
    public static <T> T loadElement(Element element, Class<T> clazz)
            throws NoSuchMethodException,
        ...
        for (Field field : fields) {
            ...
            if ("".equals(subVal)) {
                ...
                Object fieldVal =
                        element1.isTextOnly()
                                ? element1.getText()
                                : loadElement(element1, field.getType());
