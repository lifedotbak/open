...
import com.spyker.iot.vmp.gb28181.bean.AudioBroadcastCatch;
import com.spyker.iot.vmp.gb28181.bean.AudioBroadcastCatchStatus;
...
@Component
public class BroadcastResponseMessageHandler extends SIPRequestProcessorParent
        implements InitializingBean, IMessageHandler {

    private final String cmdType = "Broadcast";
    private final Logger logger = LoggerFactory.getLogger(BroadcastResponseMessageHandler.class);
    ...
    public void handForDevice(RequestEvent evt, Device device, Element rootElement) {
        ...
        try {
            ...
            logger.info(
                    "[语音广播]回复：{}, {}/{}",
                    reason == null ? result : result + ": " + reason,
                    device.getDeviceId(),
                    channelId);
            ...
            if (result.equalsIgnoreCase("OK")) {
                AudioBroadcastCatch audioBroadcastCatch =
                        audioBroadcastManager.get(device.getDeviceId(), channelId);
