...
public interface ISIPCommander {
     ...
     */
    void ptzdirectCmd(Device device, String channelId, int leftRight, int upDown)
     ...
     */
    void ptzdirectCmd(Device device, String channelId, int leftRight, int upDown, int moveSpeed)
            throws InvalidArgumentException, ParseException, SipException;
     ...
     */
    void ptzZoomCmd(Device device, String channelId, int inOut)
            throws InvalidArgumentException, ParseException, SipException;
     ...
     * @param inOut 镜头放大缩小 0:停止 1:缩小 2:放大
     */
    void ptzZoomCmd(Device device, String channelId, int inOut, int moveSpeed)
            throws InvalidArgumentException, ParseException, SipException;
    ...
    void streamByeCmd(Device device, String channelId, String stream, String callId)
            throws InvalidArgumentException,
                    ParseException,
                    SipException,
                    SsrcTransactionNotFoundException;
    ...
    void streamByeCmdForDeviceInvite(
            Device device,
            String channelId,
            SipTransactionInfo sipTransactionInfo,
            SipSubscribe.Event okEvent)
     ...
     * @param channelId 预览通道
     */
    void iFrameCmd(Device device, String channelId)
            throws InvalidArgumentException, SipException, ParseException;
     ...
     * @param device 视频设备
     */
    void deviceStatusQuery(Device device, SipSubscribe.Event errorEvent)
            throws InvalidArgumentException, SipException, ParseException;
     ...
     * @param device 视频设备
     */
    void catalogQuery(Device device, int sn, SipSubscribe.Event errorEvent)
            throws SipException, InvalidArgumentException, ParseException;
     ...
     * @param device 视频设备
     */
    void presetQuery(Device device, String channelId, SipSubscribe.Event errorEvent)
            throws InvalidArgumentException, SipException, ParseException;
     ...
     * @param device 视频设备
     */
    void mobilePostitionQuery(Device device, SipSubscribe.Event errorEvent)
            throws InvalidArgumentException, SipException, ParseException;
     ...
     * @return true = 命令发送成功
     */
    SIPRequest mobilePositionSubscribe(
            Device device,
            SIPRequest request,
            SipSubscribe.Event okEvent,
            SipSubscribe.Event errorEvent)
     ...
     * @param cmdString 前端控制指令串
     */
    void dragZoomCmd(Device device, String channelId, String cmdString)
            throws InvalidArgumentException, SipException, ParseException;
     ...
     * @return
     */
    void sendAlarmMessage(Device device, DeviceAlarm deviceAlarm)
            throws InvalidArgumentException, SipException, ParseException;
}