package com.spyker.iot.vmp.gb28181.transmit.cmd;
...
import com.spyker.iot.vmp.gb28181.bean.SipTransactionInfo;
import com.spyker.iot.vmp.gb28181.bean.SubscribeInfo;
...
public class SIPRequestHeaderPlarformProvider {
    ...
    public Request createRegisterRequest(
        ...
        ViaHeader viaHeader =
                SipFactory.getInstance()
                        ...
                        .createViaHeader(
                                ...
                                parentPlatform.getDevicePort(),
                                parentPlatform.getTransport(),
        ...
        SipURI fromSipURI =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(parentPlatform.getDeviceGBId(), sipConfig.getDomain());
        Address fromAddress =
                SipFactory.getInstance().createAddressFactory().createAddress(fromSipURI);
        ...
        ToHeader toHeader =
                SipFactory.getInstance().createHeaderFactory().createToHeader(toAddress, toTag);
        ...
        CSeqHeader cSeqHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createCSeqHeader(CSeq, Request.REGISTER);
        request =
                SipFactory.getInstance()
        ...
        request.addHeader(
                SipFactory.getInstance().createHeaderFactory().createContactHeader(concatAddress));
    ...
    public Request createRegisterRequest(
            ...
            CallIdHeader callIdHeader,
            int expires)
            throws ParseException, PeerUnavailableException, InvalidArgumentException {
        ...
        String HA1 =
                DigestUtils.md5DigestAsHex(
                        (parentPlatform.getDeviceGBId()
                                        ...
                                        + realm
                                        + ":"
                                        + parentPlatform.getPassword())
                                .getBytes());
        String HA2 =
                DigestUtils.md5DigestAsHex(
                        (Request.REGISTER + ":" + requestURI.toString()).getBytes());
        ...
        AuthorizationHeader authorizationHeader =
                SipFactory.getInstance().createHeaderFactory().createAuthorizationHeader(scheme);
        authorizationHeader.setUsername(parentPlatform.getDeviceGBId());
    ...
    public Request createMessageRequest(
            ParentPlatform parentPlatform, String content, SendRtpItem sendRtpItem)
            throws PeerUnavailableException, ParseException, InvalidArgumentException {
        CallIdHeader callIdHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createCallIdHeader(sendRtpItem.getCallId());
        callIdHeader.setCallId(sendRtpItem.getCallId());
        return createMessageRequest(
                parentPlatform,
                content,
                sendRtpItem.getToTag(),
                SipUtils.getNewViaTag(),
                sendRtpItem.getFromTag(),
                callIdHeader);
    }
    ...
    public Request createMessageRequest(
        ...
        SipURI requestURI =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(parentPlatform.getServerGBId(), serverAddress);
        // via
        ArrayList<ViaHeader> viaHeaders = new ArrayList<ViaHeader>();
        ViaHeader viaHeader =
                SipFactory.getInstance()
        ...
        // from
        // SipURI fromSipURI =
        // SipFactory.getInstance().createAddressFactory().createSipURI(parentPlatform.getDeviceGBId(), parentPlatform.getDeviceIp() + ":" + parentPlatform.getDeviceIp());
        SipURI fromSipURI =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(parentPlatform.getDeviceGBId(), sipConfig.getDomain());
    ...
    public SIPRequest createNotifyRequest(
            ParentPlatform parentPlatform, String content, SubscribeInfo subscribeInfo)
            throws PeerUnavailableException, ParseException, InvalidArgumentException {
        ...
        FromHeader fromHeader =
                SipFactory.getInstance()
                        ...
                        .createFromHeader(
                                fromAddress,
                                subscribeInfo.getResponse() != null
                                        ? subscribeInfo.getResponse().getToTag()
                                        : subscribeInfo.getSimulatedToTag());
        // to
        SipURI toSipURI =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(
                                parentPlatform.getServerGBId(), parentPlatform.getServerGBDomain());
        Address toAddress = SipFactory.getInstance().createAddressFactory().createAddress(toSipURI);
        ToHeader toHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createToHeader(
                                toAddress,
                                subscribeInfo.getRequest() != null
                                        ? subscribeInfo.getRequest().getFromTag()
                                        : subscribeInfo.getSimulatedFromTag());
        ...
        CSeqHeader cSeqHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createCSeqHeader(redisCatchStorage.getCSEQ(), Request.NOTIFY);
        MessageFactoryImpl messageFactory =
                (MessageFactoryImpl) SipFactory.getInstance().createMessageFactory();
        // 设置编码， 防止中文乱码
        ...
        CallIdHeader callIdHeader =
                SipFactory.getInstance()
                        ...
                        .createCallIdHeader(
                                subscribeInfo.getRequest() != null
                                        ? subscribeInfo.getRequest().getCallIdHeader().getCallId()
                                        : subscribeInfo.getSimulatedCallId());
        ...
        EventHeader event =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createEventHeader(subscribeInfo.getEventType());
    ...
    public SIPRequest createByeRequest(ParentPlatform platform, SendRtpItem sendRtpItem)
            throws PeerUnavailableException, ParseException, InvalidArgumentException {
        ...
        ViaHeader viaHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createViaHeader(
                                platform.getDeviceIp(),
                                platform.getDevicePort(),
        ...
        FromHeader fromHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createFromHeader(fromAddress, sendRtpItem.getToTag());
        // to
        SipURI toSipURI =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(platform.getServerGBId(), platform.getServerGBDomain());
        Address toAddress = SipFactory.getInstance().createAddressFactory().createAddress(toSipURI);
        ToHeader toHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createToHeader(toAddress, sendRtpItem.getFromTag());
        ...
        CSeqHeader cSeqHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createCSeqHeader(redisCatchStorage.getCSEQ(), Request.BYE);
    ...
    public Request createInviteRequest(
        ...
        String localHostAddress =
                sipLayer.getLocalIp(platform.getDeviceIp()) + ":" + platform.getDevicePort();
        SipURI requestLine =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(channelId, platformHostAddress);
        // via
        ArrayList<ViaHeader> viaHeaders = new ArrayList<ViaHeader>();
        ViaHeader viaHeader =
                SipFactory.getInstance()
        ...
        SipURI fromSipURI =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(platform.getDeviceGBId(), sipConfig.getDomain());
        Address fromAddress =
                SipFactory.getInstance().createAddressFactory().createAddress(fromSipURI);
        FromHeader fromHeader =
                SipFactory.getInstance()
        ...
        Address toAddress = SipFactory.getInstance().createAddressFactory().createAddress(toSipURI);
        ToHeader toHeader =
                SipFactory.getInstance().createHeaderFactory().createToHeader(toAddress, null);
        ...
        CSeqHeader cSeqHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createCSeqHeader(redisCatchStorage.getCSEQ(), Request.INVITE);
        request =
                SipFactory.getInstance()
                        .createMessageFactory()
                        .createRequest(
        ...
        Address concatAddress =
                SipFactory.getInstance()
                        ...
                        .createAddress(
                                SipFactory.getInstance()
                                        .createAddressFactory()
                                        .createSipURI(sipConfig.getId(), localHostAddress));
        request.addHeader(
                SipFactory.getInstance().createHeaderFactory().createContactHeader(concatAddress));
        // Subject
        SubjectHeader subjectHeader =
                SipFactory.getInstance()
                        ...
                        .createSubjectHeader(
                                String.format(
                                        "%s:%s,%s:%s", channelId, ssrc, sipConfig.getId(), 0));
    ...
    public Request createByteRequest(
            ParentPlatform platform, String channelId, SipTransactionInfo transactionInfo)
            throws PeerUnavailableException, ParseException, InvalidArgumentException {
        ...
        SipURI requestLine =
                SipFactory.getInstance()
                        .createAddressFactory()
                        .createSipURI(channelId, deviceHostAddress);
        ...
        FromHeader fromHeader =
                SipFactory.getInstance()
                        ...
                        .createFromHeader(
                                fromAddress,
                                transactionInfo.isAsSender()
                                        ? transactionInfo.getFromTag()
                                        : transactionInfo.getToTag());
        // to
        SipURI toSipURI =
                SipFactory.getInstance()
                        .createAddressFactory()
        ...
        CallIdHeader callIdHeader =
                SipFactory.getInstance()
                        .createHeaderFactory()
                        .createCallIdHeader(transactionInfo.getCallId());
        request =
                SipFactory.getInstance()
                        .createMessageFactory()
                        .createRequest(
