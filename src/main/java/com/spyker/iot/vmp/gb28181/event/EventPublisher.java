package com.spyker.iot.vmp.gb28181.event;

import com.spyker.iot.vmp.gb28181.bean.*;
import com.spyker.iot.vmp.gb28181.event.alarm.AlarmEvent;
import com.spyker.iot.vmp.gb28181.event.device.RequestTimeoutEvent;
import com.spyker.iot.vmp.gb28181.event.record.RecordEndEvent;
import com.spyker.iot.vmp.gb28181.event.subscribe.catalog.CatalogEvent;
import com.spyker.iot.vmp.gb28181.event.subscribe.mobilePosition.MobilePositionEvent;
import com.spyker.iot.vmp.media.event.mediaServer.MediaServerOfflineEvent;
import com.spyker.iot.vmp.media.event.mediaServer.MediaServerOnlineEvent;
...
public class EventPublisher {
     ...
     * @param type
     */
    public void catalogEventPublish(
            String platformId, List<DeviceChannel> deviceChannels, String type) {
    ...
    public void catalogEventPublishForStream(
            String platformId, List<GbStream> gbStreams, String type) {
        CatalogEvent outEvent = new CatalogEvent(this);
