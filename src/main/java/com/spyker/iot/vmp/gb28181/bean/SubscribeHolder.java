...
import com.spyker.iot.vmp.gb28181.task.impl.MobilePositionSubscribeHandlerTask;
...
public class SubscribeHolder {
    ...
    public void putMobilePositionSubscribe(String platformId, SubscribeInfo subscribeInfo) {
        ...
        String key =
                VideoManagerConstants.SIP_SUBSCRIBE_PREFIX
        ...
        dynamicTask.startCron(
                key,
                new MobilePositionSubscribeHandlerTask(platformId),
