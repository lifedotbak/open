package com.spyker.iot.vmp.gb28181.conf;

import com.spyker.iot.vmp.gb28181.transmit.event.request.impl.message.notify.cmd.AlarmNotifyMessageHandler;
...
public class DefaultProperties {
    ...
    public static Properties getProperties(String name, boolean sipLog) {
        ...
        properties.setProperty(
                "gov.nist.javax.sip.COMPUTE_CONTENT_LENGTH_FROM_MESSAGE_BODY", "true");
        // 会话清理策略
        ...
        if (sipLog) {
            properties.setProperty(
                    ...
                    "com.genersoft.iot.vmp.gb28181.conf.StackLoggerImpl");
            properties.setProperty(
                    "gov.nist.javax.sip.SERVER_LOGGER",
                    "com.genersoft.iot.vmp.gb28181.conf.ServerLoggerImpl");
