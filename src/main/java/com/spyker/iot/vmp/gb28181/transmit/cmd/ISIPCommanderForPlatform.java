...
public interface ISIPCommanderForPlatform {
     ...
     * @return
     */
    void deviceInfoResponse(ParentPlatform parentPlatform, Device device, String sn, String fromTag)
            throws SipException, InvalidArgumentException, ParseException;
     ...
     * @return
     */
    void sendAlarmMessage(ParentPlatform parentPlatform, DeviceAlarm deviceAlarm)
            throws SipException, InvalidArgumentException, ParseException;
     ...
     */
    void sendNotifyForCatalogAddOrUpdate(
            String type,
            ParentPlatform parentPlatform,
     ...
     * @return
     */
    void sendMediaStatusNotify(ParentPlatform platform, SendRtpItem sendRtpItem)
            throws SipException, InvalidArgumentException, ParseException;
