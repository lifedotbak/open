...
public interface PlatformCatalogMapper {
    ...
    @Insert(
            "INSERT INTO wvp_platform_catalog (id, name, platform_id, parent_id, civil_code, business_group_id) VALUES"
    ...
    List<PlatformCatalog> selectByParentId(
            @Param("platformId") String platformId, @Param("parentId") String parentId);
    ...
    @Select(
            "SELECT pc.id as channel_id, pc.name, pc.civil_code, pc.business_group_id,'1' as parental, pc.parent_id  "
    ...
    PlatformCatalog selectByPlatFormAndCatalogId(
            @Param("platformId") String platformId, @Param("id") String id);
    ...
    List<String> queryCatalogFromParent(
            @Param("id") String id, @Param("platformId") String platformId);
}