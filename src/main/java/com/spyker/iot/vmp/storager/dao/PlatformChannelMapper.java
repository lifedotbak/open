...
public interface PlatformChannelMapper {
    ...
    @Select(
            "<script> "
                    ...
                    + "</script>")
    List<Integer> findChannelRelatedPlatform(
    ...
    List<DeviceChannel> queryChannelInParentPlatform(
            @Param("platformId") String platformId, @Param("channelId") String channelId);
    ...
    @Select(
            "<script> "
                    ...
                    + "</script>")
    List<DeviceChannel> queryAllChannelInCatalog(
    ...
    List<Device> queryVideoDeviceByPlatformIdAndChannelId(
            @Param("platformId") String platformId, @Param("channelId") String channelId);
    ...
    List<ParentPlatform> queryPlatFormListForGBWithGBId(
            @Param("channelId") String channelId, @Param("platforms") List<String> platforms);
    ...
    @Delete(
            "<script> "
                    ...
                    + "</script>")
    int delChannelForGBByCatalogId(
            @Param("platformId") String platformId, @Param("catalogId") String catalogId);
    ...
    @Select(
            "select dc.channel_id dc.device_id,dc.name,d.manufacturer,d.model,d.firmware\n"
                    ...
                    + "         left join wvp_device d on dc.device_id = d.device_id\n"
                    + "where dc.channel_id = #{channelId} and pgc.platform_id=#{platformId}")
    List<Device> queryDeviceInfoByPlatformIdAndChannelId(
            @Param("platformId") String platformId, @Param("channelId") String channelId);

    @Select(
            "SELECT pgc.platform_id from wvp_platform_gb_channel pgc left join wvp_device_channel dc on dc.id = pgc.device_channel_id WHERE dc.channel_id=#{channelId}")
