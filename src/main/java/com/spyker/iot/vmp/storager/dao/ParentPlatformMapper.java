...
public interface ParentPlatformMapper {
    ...
    @Insert(
            "INSERT INTO wvp_platform (enable, name, server_gb_id, server_gb_domain, server_ip, server_port,device_gb_id,device_ip,"
    ...
    int updateParentPlatformStatus(
            @Param("platformGbID") String platformGbID, @Param("online") boolean online);
    ...
    int setDefaultCatalog(
            @Param("platformId") String platformId,
            @Param("catalogId") String catalogId,
            @Param("updateTime") String updateTime);

    @Select(
            "select 'channel' as name, count(pgc.platform_id) count from wvp_platform_gb_channel pgc left join wvp_device_channel dc on dc.id = pgc.device_channel_id where  pgc.platform_id=#{platform_id} and dc.channel_id =#{gbId} "
                    + "union "
    ...
    List<ChannelSourceInfo> getChannelSource(
            @Param("platform_id") String platform_id, @Param("gbId") String gbId);
}