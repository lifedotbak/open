...
public interface CloudRecordServiceMapper {
    ...
    List<CloudRecordItem> getList(
            ...
            List<MediaServer> mediaServerItemList);
    ...
    @Select(
            " <script>"
                    ...
                    + " </if>"
                    + " </script>")
    List<String> queryRecordFilePathList(
            @Param("app") String app,
            @Param("stream") String stream,
            @Param("startTimeStamp") Long startTimeStamp,
            @Param("endTimeStamp") Long endTimeStamp,
    ...
    @Update(
            " <script>"
                    ...
                    + " </script>")
    int updateCollectList(
            @Param("collect") boolean collect, List<CloudRecordItem> cloudRecordItemList);
    ...
    @Select(
            " <script>"
                    ...
                    + " </script>")
    List<CloudRecordItem> queryRecordListForDelete(
