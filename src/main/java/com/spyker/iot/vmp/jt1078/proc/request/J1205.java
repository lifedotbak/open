...
import com.spyker.iot.vmp.jt1078.session.SessionManager;
...
public class J1205 extends Re {
    ...
    protected Rs handler(Header header, Session session) {
        SessionManager.INSTANCE.response(
                header.getDevId(), "1205", (long) respNo, JSON.toJSONString(this));
    ...
    public String toString() {
        return "J1205{" + "respNo=" + respNo + ", recordList=" + recordList + '}';
    }
