...
import com.spyker.iot.vmp.gb28181.task.impl.CatalogSubscribeTask;
import com.spyker.iot.vmp.gb28181.task.impl.MobilePositionSubscribeTask;
...
import com.spyker.iot.vmp.gb28181.transmit.event.request.impl.message.response.cmd.CatalogResponseMessageHandler;
...
import com.spyker.iot.vmp.storager.dao.PlatformChannelMapper;
import com.spyker.iot.vmp.utils.DateUtil;
import com.spyker.iot.vmp.vmanager.bean.BaseTree;
...
public class DeviceServiceImpl implements IDeviceService {
    ...
    public void online(Device device, SipTransactionInfo sipTransactionInfo) {
        ...
        dynamicTask.startDelay(
                ...
                () -> offline(device.getDeviceId(), "首次注册后未能收到心跳"),
                device.getKeepaliveIntervalTime() * 1000 * 3);

        //
        //        try {
        //            cmder.alarmSubscribe(device, 600, "0", "4", "0", "2023-7-27T00:00:00",
        // "2023-7-28T00:00:00");
    ...
    public void offline(String deviceId, String reason) {
        ...
        String registerExpireTaskKey =
                VideoManagerConstants.REGISTER_EXPIRE_TASK_KEY_PREFIX + deviceId;
        ...
        if (ssrcTransactions != null && ssrcTransactions.size() > 0) {
            for (SsrcTransaction ssrcTransaction : ssrcTransactions) {
                ...
                streamSession.removeByCallId(
                        deviceId, ssrcTransaction.getChannelId(), ssrcTransaction.getCallId());
            }
        }
        // 移除订阅
    ...
    public void sync(Device device) {
        ...
        try {
            sipCommander.catalogQuery(
                    ...
                    event -> {
                        String errorMsg =
                                String.format("同步通道失败，错误码： %s, %s", event.statusCode, event.msg);
                        catalogResponseMessageHandler.setChannelSyncEnd(
                                device.getDeviceId(), errorMsg);
                    });
    ...
    public List<BaseTree<DeviceChannel>> queryVideoDeviceTree(
        ...
        List<DeviceChannel> rootNodes =
                deviceChannelMapper.getSubChannelsByDeviceId(deviceId, parentId, onlyCatalog);
    ...
    public void updateCustomDevice(Device device) {
            ...
            if (device.getSubscribeCycleForCatalog() > 0) {
                ...
                if (deviceInStore.getSubscribeCycleForCatalog() != 0) {
                    removeCatalogSubscribe(
                            ...
                            result -> {
                                // 开启订阅
                                deviceInStore.setSubscribeCycleForCatalog(
        ...
        // 移动位置订阅相关的信息
        if (deviceInStore.getSubscribeCycleForMobilePosition()
