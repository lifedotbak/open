            ...
            taskExecutor.execute(
                    () -> {
                        while (!taskQueue.isEmpty()) {
                            ...
                            try {
                                JSONObject steamMsgJson =
                                        JSON.parseObject(msg.getBody(), JSONObject.class);
                                ...
                                OnStreamChangedHookParam onStreamChangedHookParam =
                                        new OnStreamChangedHookParam();
                                ...
                                onStreamChangedHookParam.setCreateStamp(
                                ...
                                ChannelOnlineEvent channelOnlineEventLister =
                                        zlmMediaListManager.getChannelOnlineEventLister(
                                                app, stream);
                                if (channelOnlineEventLister != null) {
                                    ...
                                    zlmMediaListManager.removedChannelOnlineEventLister(
                                            app, stream);
                                }
                            } catch (Exception e) {
                                logger.warn(
                                        "[REDIS消息-流变化] 发现未处理的异常, \r\n{}",
