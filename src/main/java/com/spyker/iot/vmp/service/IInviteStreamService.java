...
public interface IInviteStreamService {
    ...
    /** 移除点播的状态信息 */
    void removeInviteInfo(InviteSessionType type, String deviceId, String channelId, String stream);

    /** 移除点播的状态信息 */
    void removeInviteInfo(InviteInfo inviteInfo);

    /** 移除点播的状态信息 */
    void removeInviteInfoByDeviceAndChannel(
            InviteSessionType inviteSessionType, String deviceId, String channelId);

    /** 获取点播的状态信息 */
    InviteInfo getInviteInfoByDeviceAndChannel(
