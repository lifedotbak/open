package com.spyker.iot.vmp.media;
...
public class MediaServerConfig implements CommandLineRunner {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MediaServerConfig.class);
    ...
    public void run(String... strings) throws Exception {
        ...
        if (defaultMediaServer != null
                && mediaSerItemInConfig.getId().equals(defaultMediaServer.getId())) {
            ...
            MediaServer mediaServerItem =
                    mediaServerService.getOneFromDatabase(mediaSerItemInConfig.getId());
