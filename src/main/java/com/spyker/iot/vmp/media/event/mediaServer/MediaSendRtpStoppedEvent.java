...
import com.spyker.iot.vmp.media.zlm.dto.hook.OnStreamNotFoundHookParam;
...
public class MediaSendRtpStoppedEvent extends ApplicationEvent {
    ...
    public static MediaSendRtpStoppedEvent getInstance(
            Object source, OnStreamNotFoundHookParam hookParam, MediaServer mediaServer) {
