package com.spyker.iot.vmp.media.bean;
...
public class MediaServer {
    ...
    public MediaServer(ZLMServerConfig zlmServerConfig, String sipIp) {
        ...
        hookIp =
                ObjectUtils.isEmpty(zlmServerConfig.getHookIp())
                        ? sipIp
                        : zlmServerConfig.getHookIp();
        sdpIp =
                ObjectUtils.isEmpty(zlmServerConfig.getSdpIp())
                        ? zlmServerConfig.getIp()
                        : zlmServerConfig.getSdpIp();
        streamIp =
                ObjectUtils.isEmpty(zlmServerConfig.getStreamIp())
                        ? zlmServerConfig.getIp()
        ...
        rtpPortRange =
                zlmServerConfig.getPortRange().replace("_", ","); // 默认使用30000,30500作为级联时发送流的端口号
