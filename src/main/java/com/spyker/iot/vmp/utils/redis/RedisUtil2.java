package com.spyker.iot.vmp.utils.redis; // package com.genersoft.iot.vmp.utils.redis;
//
...
//     * @return
//     */
//    public static Set<ZSetOperations.TypedTuple<String>> zRangeWithScore(Object key, int start,
// int end) {
//        if (redisTemplate == null) {
//            redisTemplate = SpringBeanFactory.getBean("redisTemplate");
//        }
...
//            redisTemplate = SpringBeanFactory.getBean("redisTemplate");
//        }
//        Set<String> resultKeys = (Set<String>) redisTemplate.execute((RedisCallback<Set<String>>)
// connection -> {
//            ScanOptions scanOptions = ScanOptions.scanOptions().match("*" + query +
// "*").count(1000).build();
