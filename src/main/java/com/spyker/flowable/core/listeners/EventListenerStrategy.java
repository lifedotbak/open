...
import com.spyker.flowable.common.dto.ProcessInstanceExecutionDto;
    ...
    default void saveStartEventContent(
        ...
        String parentNodeId =
                MapUtil.getStr(
                        processVariables,
                        StrUtil.format(
                                ProcessInstanceConstant.VariableKey.NODE_JUMP_KEY, activityId));
        ...
        runtimeService.removeVariable(
                executionId,
                StrUtil.format(ProcessInstanceConstant.VariableKey.NODE_JUMP_KEY, activityId));
    }
}