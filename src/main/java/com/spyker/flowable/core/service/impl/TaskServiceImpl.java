...
import com.spyker.flowable.common.constants.ApproveAttachmentTypeEnum;
...
import com.spyker.flowable.common.constants.TaskTypeEnum;
import com.spyker.flowable.common.dto.*;
import com.spyker.flowable.common.dto.flow.UploadValue;
import com.spyker.flowable.common.service.core.ITaskService;
import com.spyker.flowable.common.utils.TenantUtil;
import com.spyker.flowable.core.utils.FlowableUtils;
import com.spyker.flowable.core.vo.TaskCommentDto;
            ...
            if (task == null) {
                ...
                HistoricVariableInstance historicVariableInstance =
                        historyService
                                ...
                                .taskId(taskId)
                                .variableName(ProcessInstanceConstant.VariableKey.FLOW_UNIQUE_ID)
                                .singleResult();
                flowUniqueId =
