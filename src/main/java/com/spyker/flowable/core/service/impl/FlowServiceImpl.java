...
import com.spyker.flowable.common.service.core.IFlowService;
import com.spyker.flowable.common.utils.TenantUtil;
import com.spyker.flowable.core.utils.FlowableUtils;
import com.spyker.flowable.core.utils.ModelUtil;
...
public class FlowServiceImpl implements IFlowService {
    ...
    public R start(ProcessInstanceParamDto processInstanceParamDto) {
        ...
        // 支持自动跳过
        paramMap.put(ProcessInstanceConstant.VariableKey.ENABLE_SKIP_EXPRESSION, true);
