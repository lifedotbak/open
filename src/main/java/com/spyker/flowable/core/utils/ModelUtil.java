...
import com.spyker.flowable.common.dto.flow.node.DelayNode;
...
import com.spyker.flowable.core.expression.condition.NodeExpressionStrategyFactory;
import com.spyker.flowable.core.listeners.AllEventListener;
import com.spyker.flowable.core.listeners.ApprovalCreateListener;
import com.spyker.flowable.core.listeners.StarterUserTaskCreateListener;
import com.spyker.flowable.core.node.IDataStoreHandler;
import com.spyker.flowable.core.node.NodeDataStoreFactory;
import com.spyker.flowable.core.servicetask.ApproveServiceTask;
import com.spyker.flowable.core.servicetask.CopyServiceTask;
...
public class ModelUtil {
    ...
    private static List<FlowElement> buildParallelGatewayNode(Node node) {
        node.setTailId(
                StrUtil.format("{}{}", node.getId(), ProcessInstanceConstant.MERGE_GATEWAY_FLAG));
        List<FlowElement> flowElementList = new ArrayList<>();
