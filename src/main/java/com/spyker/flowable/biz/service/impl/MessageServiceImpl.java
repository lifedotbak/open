...
import com.spyker.flowable.biz.mapper.MessageMapper;
import com.spyker.flowable.biz.service.IClearService;
import com.spyker.flowable.biz.service.IMessageService;
...
public class MessageServiceImpl extends ServiceImpl<MessageMapper, Message>
     ...
     */
    @Override
    public R<Page<Message>> queryList(com.spyker.flowable.common.dto.MessageDto pageDto) {
     ...
     */
    @Override
    public R delete(com.spyker.flowable.common.dto.MessageDto messageDto) {
     ...
     */
    @Override
    public R read(com.spyker.flowable.common.dto.MessageDto messageDto) {
        String userId = StpUtil.getLoginIdAsString();
        this.lambdaUpdate()
