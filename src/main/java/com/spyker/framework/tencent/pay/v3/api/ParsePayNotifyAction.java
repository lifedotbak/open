...
import com.spyker.framework.tencent.pay.v3.entity.pay.PayNotify;
import com.spyker.framework.tencent.pay.v3.entity.pay.PayNotifyCiphertextParse;
import com.spyker.framework.tencent.pay.v3.entity.pay.PayNotifyResource;
import com.spyker.framework.tencent.pay.v3.utils.AesUtil;
...
//		if (null != payNotify) {
			...
			String notifyResourceStr = aesUtil.decryptToString(resource.getAssociated_data().getBytes("UTF-8"),
...
//		String body = new String(outSteam.toByteArray(), "utf-8");
		String body = new String(outSteam.toByteArray());
