...
public class AliPushUtils {
	...
	private static void pushIos(PushMessage pushMessage) {
		...
		// 打开URL "NONE" : 无跳转
		pushRequest.setAndroidOpenUrl(pushMessage.getAndroidOpenUrl()); // Android收到推送后打开对应的url,仅当AndroidOpenType="URL"有效
		pushRequest.setAndroidActivity(pushMessage.getAndroidActivity()); // 设定通知打开的activity，仅当AndroidOpenType="Activity"有效
