...
public class WebServiceClientUtils {
	...
	public static final String uploadCommonData(String myUsername, String myPassword, byte[] Buffer) {
		...
		try {
			...
			call.addParameter(new QName(soapaction, "myUsername"), org.apache.axis.encoding.XMLType.XSD_STRING,
			                  javax.xml.rpc.ParameterMode.IN);
			call.addParameter(new QName(soapaction, "myPassword"), org.apache.axis.encoding.XMLType.XSD_STRING,
			                  javax.xml.rpc.ParameterMode.IN);

			call.addParameter(new QName(soapaction, "Buffer"), org.apache.axis.encoding.XMLType.SOAP_BASE64BINARY,
			                  javax.xml.rpc.ParameterMode.IN);
