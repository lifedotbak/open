...
public final class ExDateUtils extends DateUtils {
	...
	public static boolean isDaySpan(Date start, Date end) {
		...
		Date startYMDHM = ExDateUtils.format2Date(
				ExDateUtils.date2String(startYmd,
				                        ExDateUtils.Format.YYYY_MM_DD) + " " + startHm,
				ExDateUtils.Format.YYYY_MM_DD_HH_MM);
		Date endYMDHM = ExDateUtils.format2Date(
				ExDateUtils.date2String(startYmd, ExDateUtils.Format.YYYY_MM_DD) + " " + endHm,
				ExDateUtils.Format.YYYY_MM_DD_HH_MM);
