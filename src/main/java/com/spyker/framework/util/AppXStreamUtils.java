...
public final class AppXStreamUtils {
	...
	private static Log log = LogFactory.getLog(AppXStreamUtils.class);

	private static final String XML_HEARD = "<?xml version='1.0' encoding='UTF-8'?>";

	public final static String java2Xml(Object object, String aliasTypeName) {
	...
	public final static Object xml2java(String xml, Class<?> classValue) {
		XStream xs = new XStream();
