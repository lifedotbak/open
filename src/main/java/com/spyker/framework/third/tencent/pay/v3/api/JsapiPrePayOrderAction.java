...
import com.spyker.framework.third.tencent.pay.v3.entity.pay.JsapiPrePayOrderResult;
...
public class JsapiPrePayOrderAction {
    ...
    private RequestAuth create(final PrePayOrder prePayOrder) {
        ...
        final String nonceStr = ExRandomStringUtils.random32();
    ...
    private JsapiPrePayOrderResult signCallback(
            final JsapiPrePayOrderResult jsapiPrePayOrderResult) {
