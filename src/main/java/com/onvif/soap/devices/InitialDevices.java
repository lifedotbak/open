package com.onvif.soap.devices;

import com.onvif.soap.OnvifDevice;
import com.onvif.soap.SOAP;
...
public class InitialDevices {
        ...
        try {
            response =
                    (GetSystemDateAndTimeResponse)
                            soap.createSOAPDeviceRequest(
                                    new GetSystemDateAndTime(), response, false);
        ...
        try {
            response =
                    (GetDeviceInformationResponse)
                            soap.createSOAPDeviceRequest(getHostname, response, true);
        } catch (SOAPException | ConnectException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String getHostname() {
        ...
        try {
            response =
                    (GetHostnameResponse) soap.createSOAPDeviceRequest(getHostname, response, true);
        } catch (SOAPException | ConnectException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public boolean setHostname(String hostname) {
        ...
        try {
            response =
                    (SetHostnameResponse) soap.createSOAPDeviceRequest(setHostname, response, true);
        } catch (SOAPException | ConnectException e) {
            e.printStackTrace();
            return false;
        }
    ...
    public Capabilities getCapabilities() throws ConnectException, SOAPException {
        ...
        try {
            // 将摄像头Ip组合出webservice接口访问地址
            response =
                    (GetCapabilitiesResponse)
                            soap.createSOAPRequest(
                                    getCapabilities, response, onvifDevice.getDeviceUri(), false);
