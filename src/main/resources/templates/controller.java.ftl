...
public class ${table.controllerName} {
    ...
    public RestResponse<List<${entity}>> list(${entity}Search search) {    
        List<${entity}> ${entity}List = ${table.serviceName?uncap_first}.query(search);
        
        return RestResponse.success(${entity}List);
    }
    ...
    @GetMapping("detail")
    public RestResponse<${entity}> detail(@RequestParam Long id) {
      	${entity} ${entity} = ${table.serviceName?uncap_first}.get(id);
    ...
    public RestResponse<?> add(@RequestBody ${entity} ${entity}) {
        ...
        return ${table.serviceName?uncap_first}.insert(${entity});
    }
