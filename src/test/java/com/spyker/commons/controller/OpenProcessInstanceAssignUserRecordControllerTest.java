...
@Slf4j
public class OpenProcessInstanceAssignUserRecordControllerTest extends BaseTest {

    // @formatter:off

    private static final String BASE_URL = "/commons/open-process-instance-assign-user-record";
