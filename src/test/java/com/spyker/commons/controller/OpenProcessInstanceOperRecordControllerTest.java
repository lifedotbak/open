...
@Slf4j
public class OpenProcessInstanceOperRecordControllerTest extends BaseTest {

    // @formatter:off

    private static final String BASE_URL = "/commons/open-process-instance-oper-record";
