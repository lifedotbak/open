...
@Slf4j
public class SysProcessInstanceAssignUserRecordControllerTest extends BaseTest {

    private static final String BASE_URL = "/commons/sys-process-instance-assign-user-record";
