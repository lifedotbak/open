...
@Slf4j
public class OpenProcessInstanceNodeRecordControllerTest extends BaseTest {

    // @formatter:off

    private static final String BASE_URL = "/commons/open-process-instance-node-record";
