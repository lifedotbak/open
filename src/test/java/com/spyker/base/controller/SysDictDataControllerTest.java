package com.spyker.base.controller;
...
@Slf4j
public class SysDictDataControllerTest extends BaseTest {

    private static String URL = "/application/sys-dict-data";
