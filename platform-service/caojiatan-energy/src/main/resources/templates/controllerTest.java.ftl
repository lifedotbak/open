...
public class ${table.controllerName} extends BaseTest {

  private static String URL ="/<#if controllerMappingHyphenStyle??>${controllerMappingHyphen}<#else>${table.entityPath}</#if>";
