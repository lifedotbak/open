...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_id` (`id` ASC) USING BTREE
) ENGINE = InnoDB COMMENT = '流程抄送数据--用户和实例唯一值'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_id` (`id` ASC) USING BTREE
) ENGINE = InnoDB COMMENT = '流程执行id数据'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_id` (`id` ASC) USING BTREE
) ENGINE = InnoDB COMMENT = '流程节点记录-执行人'
  ROW_FORMAT = DYNAMIC;
